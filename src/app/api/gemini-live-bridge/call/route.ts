    ...
    data: {
      ...
      conversationRaw: {
        ...
        initialPrompt:
          ...
          `Hi ${member.name}, this is DailyCall through Gemini Live. I am here if anything is on your mind, or if you would just like a quick chat. How are you doing today?`,
        hybridTranscript: [],
