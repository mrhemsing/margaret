  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-6xl flex-col gap-10 px-5 pb-16 pt-0 text-ink sm:px-6 md:px-10">
      ...
      <section className="grid gap-8 pt-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        ...
        <figure className="overflow-hidden rounded-[2rem] bg-white p-3 shadow-sm ring-1 ring-black/5">
          <Image
          ...
          />
          <figcaption className="px-2 pt-3 text-sm font-semibold leading-6 text-slate-500">
        ...
        <aside className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-black/5">
          ...
          <div className="mt-5">
            ...
            <Link
              ...
              className="mt-5 inline-flex rounded-full bg-brandButtonBlue px-5 py-3 text-sm font-bold text-cream shadow-sm hover:bg-brandButtonBlueHover"
            >
              LinkedIn profile
            </Link>
          </div>
