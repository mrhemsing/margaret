...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/founder-margaret-family-watercolor-about-us-3gg.png",
        width: 2192,
        height: 1982,
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-6xl flex-col gap-8 px-5 pb-16 pt-0 text-ink sm:px-6 md:px-10">
      ...
      <section className="grid gap-8 rounded-[2rem] bg-white/85 p-6 shadow-sm ring-1 ring-black/5 md:rounded-none md:bg-transparent md:p-0 md:shadow-none md:ring-0 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        ...
        <Image
          src="/founder-margaret-family-watercolor-about-us-3gg.png"
          alt="Matt Hemsing with his grandmother Margaret and family"
          width={2192}
          height={1982}
          priority
          className="w-full rounded-[1.5rem] object-cover md:rounded-none"
        />
      </section>
